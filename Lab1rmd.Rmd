...
X <- matrix(nrow = 6000, ncol = 201)
for (i in 1:6000) {
  X[i,] = matrix(rnorm(201, mean = 0, sd = 1), nrow = 1, ncol = 201)
}
...
\vdots \\
x_{n, 1}\end{pmatrix}$$\
With the matrix $X$ defined in the previous question, we define 
$$ X^{'} = \begin{pmatrix} 1 & x_{1,2} & \cdots & x_{1,p} \\ 
