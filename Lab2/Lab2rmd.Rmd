...
# b steps
plot(1, type="n", xlab="Number of components", ylab="Error", 
...
* Following the same idea as the first point, if we had a circle of possibiliy instead of a center point, the linear regression would give better results since it wouldn't predict our those centers.
